...
$buscar = $_POST['buscar'];
$sql = "SELECT nom_prod, marca_prod, precio, stock, img, id_prod FROM producto WHERE nom_prod LIKE '$buscar' '%'";
...
?>	
	<center><p><?php echo "No se encontraron resultados de '<b>".$buscar."</b>'";?></p></center>
<?php
}
?>